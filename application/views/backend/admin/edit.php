        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="x_panel">
                        ...
                        <form class="form-horizontal form-label-left" novalidate action="<?php echo base_url(); ?>Manteiner/Cadmin/update" method="post">
                            ...
                            <!-- <input type="hidden" name="dontedit" value="<?php echo $alladmin->CEDULA_PER; ?>"> -->
                            <div class="item form-group">
                                <label class="col-form-label col-md-1 col-sm-3 label-align" for="name">Cédula</label>
                                <div class="col-md-5 col-sm-6">
                                    <input id="txtcedula" type="txtcedula" class="form-control" name="txtcedula" value="<?php echo $alladmin->CEDULA_PER; ?>"onkeyup=" ValNumero(this);" maxlength="10">
                                </div>
                            ...
                            <span><h2 class="color-black">Cuenta</h2> </span>
                            <div class="item form-group">
                                <label class="col-form-label col-md-1 col-sm-3 label-align" for="email">Usuario <span class="required">*</span>
                                </label>
                                <div class="col-md-5 col-sm-6">
                                    <input id="usuarioA" type="txtusuario" name="txtusuario" required="required" class="form-control" value="<?php echo $alladmin->CEDULA_PER; ?>" disabled>
                                </div>
    
                                <label class="col-form-label col-md-1 col-sm-3 label-align" for="email">Contraseña <span class="required">*</span>
                                </label>
                                <div class="col-md-5 col-sm-6">
                                    <input id="contraseñaA" type="txtcontraseña" name="txtcontraseña" required="required" class="form-control">
                                </div>
                            </div>
                            </div>
